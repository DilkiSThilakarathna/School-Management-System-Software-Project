...
// 3.PARENTS
// 3.1 Add Parent
router.get('/addParent', requireAuth, controller.getAddParent);
router.post('/addParent', requireAuth, controller.postAddParent);
// 3.2 Get Parents on query
router.get('/getParent', requireAuth, controller.getRelevantParent);
router.post('/getParent', requireAuth, controller.postRelevantParent);
// 3.3 Get all Parents
router.get('/getAllParents', requireAuth, controller.getAllParent);
// 3.4 Modify existing Parents
